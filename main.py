...
btn_mul = tk.Button(root, text="x", command=lambda: add_to_calculation("*"), width=5, font=("Ariel", 14))
...
btn_clear = tk.Button(root, text="C", command=clear_field, width=14, font=("Ariel", 14))
btn_clear.grid(row=6, column=1,columnspan=2)
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=14, font=("Ariel", 14))
